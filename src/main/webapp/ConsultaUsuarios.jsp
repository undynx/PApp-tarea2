  ...
  <body>
    ...
    -->
                  ...
                  <div class="container-fluid" aria-labelledby="datosEspecificos">
                    ...
                    <% String tipo=(String) session.getAttribute("tipo"); if ("Profesor".equals(tipo)) { %>
                                ...
                                <div class="col-sm-3">
                                  <form action="ConsultaDictadoClase" method="post">
                                    <input type="hidden" id="instituto" name="instituto"
                                      value="<%= request.getAttribute(" nombreIntitusion") %>">
                                    <input type="hidden" id="actividad" name="actividad"
                                      value="<%= clase.getActividadDeportiva().getNombre() %>">
                            ...
                            <tbody>
                              <% List<DtClase> clases2 = (List<DtClase>) request.getAttribute("listaClasesProf");
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                      <a
                                        href="ConsultaActividades.jsp?unaActividad=<%= clase.getActividadDeportiva().getNombre() %>">
